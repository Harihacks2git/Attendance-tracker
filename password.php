    ...
    <div class="high">
        <div class="main">
            ...
            <form action="set_password.php" method="post" onsubmit="return validatePasswordForm()">
                <div class="in-1">
                Password: <input type="password" id="password" class="pass" name="password">
                <!-- <button type="button" onclick="togglePasswordVisibility1()" class="show">&#128065;</button></div><div class="in-2"> -->
                Confirm: <input type="password" id="confirm_password" class="pass"name="confirm_password">
                <!-- <button type="button" onclick="togglePasswordVisibility2()" class="show">&#128065;</button> -->
            </div><br>
